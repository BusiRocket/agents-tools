...
- **Next.js**: `.cursor/rules/nextjs.mdc` — App Router architecture bundle
- **React**: `.cursor/rules/react.mdc` — architecture, hooks, state, a11y, forms, performance
- **JavaScript** (optional): `.cursor/rules/javascript.mdc` — extensions, QA, RN/Expo, Shopify JS, cross-runtime rules
...
- **Tailwind**: `.cursor/rules/tailwind.mdc` — Tailwind v4 standards split by concept
