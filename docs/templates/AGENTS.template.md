...
<!--
Template from BusiRocket/agents-tools docs/agent-ready-repo-standard.md.
...
**This is production infrastructure. Do not deploy, restart, or modify
anything in <environment> without explicit human authorization.** Read-only
inspection is fine.
