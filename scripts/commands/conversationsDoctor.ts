...
export const main = async () => {
  ...
  const { artifacts, statuses } = await inspectConversationSources(home, selection.sources)
  const output = { ok: true, home: "[HOME]", artifacts: artifacts.length, sources: statuses }
  console.log(
