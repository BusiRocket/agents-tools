...
export const conversationEventKindFromRecord = (record: unknown): ConversationEventKind => {
  ...
  if (
    ...
    return "tool-call"
  if (candidate.includes("reasoning") || candidate.includes("thinking")) return "reasoning"
  if (candidate.includes("summary") || candidate.includes("compact")) return "summary"
